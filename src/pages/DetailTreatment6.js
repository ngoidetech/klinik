...
const HeadingDescription = tw.p`text-sm text-center md:text-base lg:text-lg font-medium leading-relaxed text-secondary-100 mt-8`;
  ...
  return (
    <AnimationRevealPage>
      <Container>
        <Header />
        <Content>
          <HeadingTitle>Konsultasi</HeadingTitle>
          <HeadingDescription>
            Ditangani oleh ahli bidang kesehatan reproduksi & dokter umum /
            spesialis
          </HeadingDescription>
          <ThreeColumn>
